...
void main()
{
	...
	strcpy(argv[10],"60");
	//训练样本文件
	strcpy(argv[11], "..\\sampleL.txt");
	//SVM模型文件
	strcpy(argv[12], "..\\mdl_sampleL_c10_t2_g01.txt");
...
void print_help()
{
  ...
  printf("[5] T. Joachims, The Maximum-Margin Approach to Learning Text Classifiers:\n");
  printf("    Methods, Theory, and Algorithms. Dissertation, Universitaet Dortmund,\n");
  printf("    2000, to appear.\n\n");
}
